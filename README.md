...
Instead of a generic chatbot, NutriRate uses **Augmented Prompting**. The app dynamically injects user-specific biometric data (Age, Weight, Daily Calorie Goal) from the database into the LLM context.
...
## ✨ Key Features
* **🇮🇳 Culturally Aware Chat:** An AI coach that recognizes dishes like *Moong Dal Chilla* or *Paneer Butter Masala*.
* **📊 Personalized Nutrition:** Integrates with a database service to track Age, Weight, and Caloric targets.
...
* **Backend:** Database Services (Supabase/Local)
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/your-username/nutrirate-app.git](https://github.com/your-username/nutrirate-app.git)
   cd nutrirate_app
   ```
Handle Secrets:
